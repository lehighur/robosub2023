...
struct Detection2DArray_
{
  ...
  using _detections_type =
    std::vector<vision_msgs::msg::Detection2D_<ContainerAllocator>, typename ContainerAllocator::template rebind<vision_msgs::msg::Detection2D_<ContainerAllocator>>::other>;
  ...
  Type & set__detections(
    const std::vector<vision_msgs::msg::Detection2D_<ContainerAllocator>, typename ContainerAllocator::template rebind<vision_msgs::msg::Detection2D_<ContainerAllocator>>::other> & _arg)
  {
