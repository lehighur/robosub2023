...
struct LabelInfo_
{
  ...
  using _class_map_type =
    std::vector<vision_msgs::msg::VisionClass_<ContainerAllocator>, typename ContainerAllocator::template rebind<vision_msgs::msg::VisionClass_<ContainerAllocator>>::other>;
  ...
  Type & set__class_map(
    const std::vector<vision_msgs::msg::VisionClass_<ContainerAllocator>, typename ContainerAllocator::template rebind<vision_msgs::msg::VisionClass_<ContainerAllocator>>::other> & _arg)
  {
    this->class_map = _arg;
    return *this;
  }
