...
struct BoundingBox3DArray_
{
  ...
  _header_type header;
  using _boxes_type =
    std::vector<vision_msgs::msg::BoundingBox3D_<ContainerAllocator>, typename ContainerAllocator::template rebind<vision_msgs::msg::BoundingBox3D_<ContainerAllocator>>::other>;
  _boxes_type boxes;
  ...
  Type & set__boxes(
    const std::vector<vision_msgs::msg::BoundingBox3D_<ContainerAllocator>, typename ContainerAllocator::template rebind<vision_msgs::msg::BoundingBox3D_<ContainerAllocator>>::other> & _arg)
  {
    this->boxes = _arg;
    return *this;
  }
